...
Release: 1%{?dist}
Source0: https://api.github.com/repos/GrapheneOS/hardened_malloc/tarball/2025110800
...
#add a bocs variant
cp config/default.mk config/bocs.mk;
sed -i 's/CONFIG_BLOCK_OPS_CHECK_SIZE := false/CONFIG_BLOCK_OPS_CHECK_SIZE := true/' config/bocs.mk;
ln -s bocs.mk config/bocs-x86-64.mk;
ln -s bocs.mk config/bocs-x86-64-v2.mk;
ln -s bocs.mk config/bocs-x86-64-v3.mk;
ln -s bocs.mk config/bocs-x86-64-v4.mk;
...
%{__make} CONFIG_NATIVE=false CONFIG_WERROR=false VARIANT=bocs;
%{__make} CONFIG_NATIVE=false CONFIG_X86_64=true CONFIG_WERROR=false VARIANT=bocs-x86-64;
%{__make} CONFIG_NATIVE=false CONFIG_X86_64_V2=true CONFIG_WERROR=false VARIANT=bocs-x86-64-v2;
%{__make} CONFIG_NATIVE=false CONFIG_X86_64_V3=true CONFIG_WERROR=false VARIANT=bocs-x86-64-v3;
%{__make} CONFIG_NATIVE=false CONFIG_X86_64_V4=true CONFIG_WERROR=false VARIANT=bocs-x86-64-v4;
...
install -Dm4644 "%{_srcdir}/out-bocs/libhardened_malloc-bocs.so" %{buildroot}/lib64/libhardened_malloc-bocs.so;
install -Dm4644 "%{_srcdir}/out-bocs-x86-64/libhardened_malloc-bocs-x86-64.so" %{buildroot}/lib64/glibc-hwcaps/x86-64/libhardened_malloc-bocs.so;
install -Dm4644 "%{_srcdir}/out-bocs-x86-64-v2/libhardened_malloc-bocs-x86-64-v2.so" %{buildroot}/lib64/glibc-hwcaps/x86-64-v2/libhardened_malloc-bocs.so;
install -Dm4644 "%{_srcdir}/out-bocs-x86-64-v3/libhardened_malloc-bocs-x86-64-v3.so" %{buildroot}/lib64/glibc-hwcaps/x86-64-v3/libhardened_malloc-bocs.so;
install -Dm4644 "%{_srcdir}/out-bocs-x86-64-v4/libhardened_malloc-bocs-x86-64-v4.so" %{buildroot}/lib64/glibc-hwcaps/x86-64-v4/libhardened_malloc-bocs.so;
...
/lib64/libhardened_malloc-bocs.so
...
/lib64/glibc-hwcaps/x86-64/libhardened_malloc-bocs.so
/lib64/glibc-hwcaps/x86-64-v2/libhardened_malloc-bocs.so
/lib64/glibc-hwcaps/x86-64-v3/libhardened_malloc-bocs.so
/lib64/glibc-hwcaps/x86-64-v4/libhardened_malloc-bocs.so
